...
+ ".onm-addbtn{font:700 15px 'Inter',sans-serif;color:#3A383D;background:#FFB300;border:none;border-radius:9999px;padding:12px 26px;cursor:pointer;transition:background 200ms cubic-bezier(.2,.8,.2,1)}"
+ ".onm-addbtn:hover:not(:disabled){background:#E69F00}"
+ ".onm-addbtn:disabled{background:#EDECEE;color:#B5B3B8;cursor:default}"
